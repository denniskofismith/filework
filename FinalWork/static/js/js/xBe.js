...
const available = document.getAnimations("availablecont")
const occupied = document.getElementById("occupiedcont")

// Function to check the occupancy status and move the card
function checkOccupancy(status) {
  if (status === "Class Available") {
    availableTab.appendChild(holder); // Move to Available tab
    document.getElementById("").click(); // Automatically switch to Available tab
  } else{
